...
var faqAnswers = map[string]string{
	...
	"9": `Is this a full penetration test? <strong>No.</strong> The standard product is an automated, <strong>external, read-only web security assessment</strong> of your public attack surface with human-reviewed findings. It does not test authenticated areas, authorization (IDOR), or business logic. If your app has critical authenticated flows, pair it with our <strong>whitebox</strong> tier (source + authenticated manual testing by a human engineer, $10,000 USD per app/domain).`,
}
